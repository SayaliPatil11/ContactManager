...
import com.mangoapps.contactmanager.databinding.FragmentOutgoingCallsBinding
...
class OutgoingCallFragment : Fragment(), IListItemClick {
    ...
    override fun onCreateView(
        ...
        callLogsViewModel.outgoingCallLogs.observe(viewLifecycleOwner) {
            binding.rlOutgoingCalls.apply {
                adapter = it?.let { it1 ->
